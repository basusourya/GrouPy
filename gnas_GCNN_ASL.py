...
def ASL_trainloader(aug_dict=aug_dict, aug_array=aug_array, seed=12345, train_batch_size = 64, mini_trainsize = 4000, mini_train=True):
  ...
  trainset = ASL(train_csv=train_csv, test_csv=test_csv, train=True, transform=transform)
...
def ASL_testloader(aug_dict=aug_dict, aug_array=aug_array, seed=12345, test_batch_size = 1000, mini_testsize = 1000, mini_test=True):
  ...
  testset = ASL(train_csv=train_csv, test_csv=test_csv, train=False, transform=testtransform)
