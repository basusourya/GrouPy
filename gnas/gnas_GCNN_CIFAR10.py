...
class GNet(nn.Module):
    def __init__(self, GConv1='Z2ConvZ2', GConv2='Z2ConvZ2', net_size=1.5):
        ...
        self.conv1 = gconv_dict[GConv1](3, channels, kernel_size=3)
        ...
        self.fc1 = nn.Linear(5*5*channels*splitgroup_size, dense_neurons)
...
def train(net, trainloader, criterion, optimizer, epoch, device='cuda', num_epochs=20, use_cuda=True):
...
def test(net, testloader, device='cuda', use_cuda=True):         
  correct = 0
  total = 0
