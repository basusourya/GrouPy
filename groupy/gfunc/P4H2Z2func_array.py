...
import groupy.garray.P4H2Z2_array as p4h2z2a
from groupy.gfunc.gfuncarray import GFuncArray


class P4H2Z2FuncArray(GFuncArray):
    ...
    def __init__(self, v, umin=None, umax=None, vmin=None, vmax=None):
        ...
        i2g = p4h2z2a.meshgrid(
            m=p4h2z2a.m_range(),
            r=p4h2z2a.r_range(0, 4),
            u=p4h2z2a.u_range(self.umin, self.umax + 1),
            v=p4h2z2a.v_range(self.vmin, self.vmax + 1)
        )
        ...
        super(P4H2Z2FuncArray, self).__init__(v=v, i2g=i2g)
