...
import groupy.garray.V2Z2_array as v2z2a
from groupy.gfunc.gfuncarray import GFuncArray


class V2Z2FuncArray(GFuncArray):
    ...
    def __init__(self, v, umin=None, umax=None, vmin=None, vmax=None):
        ...
        i2g = v2z2a.meshgrid(
            m=v2z2a.m_range(),
            u=v2z2a.u_range(self.umin, self.umax + 1),
            v=v2z2a.v_range(self.vmin, self.vmax + 1)
        )

        super(V2Z2FuncArray, self).__init__(v=v, i2g=i2g)
